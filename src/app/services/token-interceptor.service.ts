            ...
            switchMap((token) => {
                req = req.clone({
                    setHeaders: {
                        ...
                        mibot_session: `{"project_uid":"${
                            MIBOT_SESSION.project_uid || this.authService.getClientAndProjectUid().project
                        }","client_uid":"${
                            MIBOT_SESSION.client_uid || this.authService.getClientAndProjectUid().client
                        }"}`,
                    },
                });
