...
import { GroupsTableComponent } from './configuration/groups/groups-table/groups-table.component';
...
import { GroupCreateUpdateComponent } from './configuration/groups/groups-table/group-create-update/group-create-update.component';
